...
function collectUncommitted({ cwd, log: log61 = import_npmlog.default }) {
  log61.silly("collect-uncommitted", "git status --porcelain (async)");
...
var import_devkit2, import_cosmiconfig, import_dedent2, import_fs, import_glob_parent, import_globby2, import_js_yaml, import_load_json_file2, import_npmlog8, import_p_map2, import_path5, LICENSE_GLOB, Project, getPackages, getPackagesSync;
...
var import_devkit4, import_clone_deep, import_dedent3, import_lodash4, import_npmlog12, import_client, import_os3, DEFAULT_CONCURRENCY, Command;
  ...
  "libs/core/src/lib/command/index.ts"() {
    ...
    Command = class {
      ...
      async detectProjects() {
        const projectGraph = await (0, import_devkit4.createProjectGraphAsync)();
        if (import_devkit4.createProjectFileMapUsingProjectGraph) {
          this.projectFileMap = await (0, import_devkit4.createProjectFileMapUsingProjectGraph)(projectGraph);
        } else {
          this.projectFileMap = (0, import_lodash4.mapValues)(projectGraph.nodes, (node) => node.data.files);
        }
...
function updateChangelog(pkg2, type, { changelogPreset, rootPath, tagPrefix = "v", version }) {
...
var import_semver4, childProcess5;
...
function getCycles(dependencies) {
  ...
  function dfs(next, path23) {
    ...
    for (const dep of dependencies[next] || []) {
      if (path23.includes(dep.target)) {
        const cycle = path23.slice(path23.indexOf(dep.target));
        cycles.push(cycle);
      } else if (!visited.has(dep.target)) {
        dfs(dep.target, path23);
      }
    }
    path23.pop();
  }
...
function mergeOverlappingCycles(cycles) {
  ...
  cycles.forEach((cycle) => {
    ...
    const mergedCycle = mergedCycles.find((mergedCycle2) => {
      intersectionNodes = (0, import_lodash5.intersection)(mergedCycle2, cycle);
      return intersectionNodes.length > 0;
    });
    if (mergedCycle) {
      mergedCycle.push(...(0, import_lodash5.difference)(cycle, intersectionNodes));
    } else {
...
function reportCycles(cycles, rejectCycles) {
  ...
  import_npmlog18.default.warn("ECYCLE", cycleMessage);
}
var import_npmlog18;
...
function logPacked(tarball) {
  import_npmlog19.default.notice("");
  import_npmlog19.default.notice("", `${hasUnicode ? "\u{1F4E6} " : "package:"} ${tarball.name}@${tarball.version}`);
  if (tarball.files && tarball.files.length) {
    import_npmlog19.default.notice("=== Tarball Contents ===");
    import_npmlog19.default.notice(
      "",
  ...
  if (tarball.bundled && tarball.bundled.length) {
    import_npmlog19.default.notice("=== Bundled Dependencies ===");
    tarball.bundled.forEach((name) => import_npmlog19.default.notice("", name));
  }
  import_npmlog19.default.notice("=== Tarball Details ===");
  import_npmlog19.default.notice(
    "",
    (0, import_columnify2.default)(
      [
...
var import_byte_size, import_columnify2, import_npmlog19, import_has_unicode, hasUnicode;
...
function getNpmExecOpts(pkg2, registry) {
  ...
  import_npmlog20.default.silly("getNpmExecOpts", pkg2.location, registry);
  return {
    cwd: pkg2.location,
    env,
    pkg: pkg2
...
function npmInstall(pkg2, { registry, npmClient, npmClientArgs, npmGlobalStyle, mutex, stdio = "pipe", subCommand = "install" }) {
  ...
  import_npmlog21.default.silly("npmInstall", [cmd, args]);
  return childProcess6.exec(cmd, args, opts);
}
function npmInstallDependencies(pkg2, dependencies, config) {
  import_npmlog21.default.silly("npmInstallDependencies", pkg2.name, dependencies);
  if (!(dependencies && dependencies.length)) {
    import_npmlog21.default.verbose("npmInstallDependencies", "no dependencies to install");
    return Promise.resolve();
  }
  const packageJsonBkp = `${pkg2.manifestLocation}.lerna_backup`;
  import_npmlog21.default.silly("npmInstallDependencies", "backup", pkg2.manifestLocation);
  return import_fs_extra4.default.copy(pkg2.manifestLocation, packageJsonBkp).then(() => {
    const cleanup = () => {
      import_npmlog21.default.silly("npmInstallDependencies", "cleanup", pkg2.manifestLocation);
    ...
    import_npmlog21.default.silly("npmInstallDependencies", "writing tempJson", tempJson);
...
var import_fs_extra4, import_npm_package_arg4, import_npmlog21, import_signal_exit, import_write_pkg2, childProcess6;
...
function promptConfirmation(message) {
  ...
  return import_inquirer.default.prompt([
    ...
    import_npmlog22.default.resume();
...
var import_inquirer, import_npmlog22;
...
function runLifecycle(pkg2, stage, options) {
  ...
  if (import_npmlog23.default.level !== "silent") {
  ...
  return queue.add(
    async () => runScript({
      ...
      (err) => {
        ...
        import_npmlog23.default.error("lifecycle", "%j errored in %j, exiting %d", stage, pkg2.name, exitCode);
...
var import_npmlog23, import_p_queue, runScript, npmConf, queue;
...
var import_fs_extra5, import_libnpmpublish, import_npm_package_arg5, import_npmlog24, import_path14, import_pify2, readJSON, readJSONAsync;
...
function npmRunScript(script, { args, npmClient, pkg: pkg2, reject = true }) {
  import_npmlog25.default.silly("npmRunScript", script, args, pkg2.name);
  const argv = ["run", script, ...args];
  const opts = makeOpts(pkg2, reject);
  return childProcess7.exec(npmClient, argv, opts);
}
function npmRunScriptStreaming(script, { args, npmClient, pkg: pkg2, prefix, reject = true }) {
  import_npmlog25.default.silly("npmRunScriptStreaming", [script, args, pkg2.name]);
  const argv = ["run", script, ...args];
  const opts = makeOpts(pkg2, reject);
  return childProcess7.spawnStreaming(npmClient, argv, opts, prefix && pkg2.name);
}
...
var import_npmlog25, childProcess7;
...
function output(...args) {
  import_npmlog26.default["clearProgress"]();
  console.log(...args);
  import_npmlog26.default["showProgress"]();
}
var import_npmlog26;
...
var import_npm_packlist, import_npmlog27, import_path17, import_tar2;
...
var import_fs_extra7, import_npmlog28, import_upath, hrtimeToMicroseconds, range, getTimeBasedFilename, Profiler;
var init_profiler = __esm({
  "libs/core/src/lib/profiler.ts"() {
    ...
    Profiler = class {
      ...
      outputPath;
      threads;
      constructor({ concurrency, log: log61 = import_npmlog28.default, outputDirectory }) {
        this.events = [];
        this.logger = log61;
...
function pulseStart(prefix) {
  ...
  pulse = setInterval(() => import_npmlog29.default["gauge"].pulse(prefix), 150);
}
function pulseStop() {
  pulsers -= 1;
  if (pulsers > 0) {
...
var import_npmlog29, pulsers, pulse;
...
async function rimrafDir(dirPath) {
  import_npmlog30.default.silly("rimrafDir", dirPath);
  ...
  import_npmlog30.default.verbose("rimrafDir", "removed", dirPath);
}
var import_fs4, import_npmlog30, import_rimraf;
...
async function runProjectsTopologically(projects, projectGraph, runner, { concurrency, rejectCycles } = {}) {
  ...
  const projectsMap = new Map(projects.map((p) => [p.name, p]));
  const localDependencies = projectGraph.localPackageDependencies;
  const flattenedLocalDependencies = (0, import_lodash7.flatten)(Object.values(localDependencies));
  const getProject = (name) => {
    const project = projectsMap.get(name);
    if (!project) {
      throw new Error(`Failed to find project ${name}. This is likely a bug in Lerna's toposort algorithm.`);
...
var import_lodash7, import_p_queue2;
...
function createGitHubClient() {
  import_npmlog31.default.silly("createGitHubClient");
...
function parseGitRepo(remote = "origin", opts) {
  import_npmlog31.default.silly("parseGitRepo");
  const args = ["config", "--get", `remote.${remote}.url`];
  import_npmlog31.default.verbose("git", args);
  const url2 = childProcess8.execSync("git", args, opts);
  if (!url2) {
    throw new ValidationError("", `Git remote URL could not be found using "${remote}".`);
  }
  return (0, import_git_url_parse.default)(url2);
}
var import_rest, import_git_url_parse, import_npmlog31, childProcess8;
...
var import_node_fetch, import_npmlog32, import_path18, GitLabClient;
  ...
  "libs/core/src/lib/scm-clients/gitlab/gitlab-client.ts"() {
    ...
    GitLabClient = class {
      ...
      createRelease({ owner, repo, name, tag_name: tagName, body }) {
        ...
        import_npmlog32.default.silly("Requesting GitLab releases", releasesUrl);
        return (0, import_node_fetch.default)(releasesUrl, {
          ...
          if (!ok) {
            import_npmlog32.default.error("gitlab", `Failed to create release
Request returned ${status} ${statusText}`);
          } else {
            import_npmlog32.default.silly("gitlab", "Created release successfully.");
          }
        });
      }
...
function createGitLabClient() {
  ...
  import_npmlog33.default.silly("Creating a GitLab client...");
  if (!GL_TOKEN) {
...
var import_npm_package_arg6, import_npm_registry_fetch, import_npmlog34;
...
function hasTags2(opts) {
  import_npmlog35.default.silly("hasTags");
  let result = false;
  try {
    result = !!childProcess9.execSync("git", ["tag"], opts);
  } catch (err) {
    import_npmlog35.default.warn("ENOTAGS", "No git tags were reachable from this branch!");
    import_npmlog35.default.verbose("hasTags error", err);
  }
  import_npmlog35.default.verbose("hasTags", result);
  return result;
}
var import_npmlog35, childProcess9;
...
function makeDiffPredicate2(committish, execOpts, ignorePatterns = []) {
  ...
  if (ignoreFilters.size) {
    import_npmlog36.default.info("ignoring diff in paths matching", ignorePatterns);
  }
  return function hasDiffSinceThatIsntIgnored(node) {
    const diff = diffSinceIn2(committish, node.location, execOpts);
    if (diff === "") {
      import_npmlog36.default.silly("", "no diff found in %s", node.name);
      return false;
    }
    import_npmlog36.default.silly("found diff in", diff);
    let changedFiles = diff.split("\n");
    if (ignoreFilters.size) {
      for (const ignored of ignoreFilters) {
        changedFiles = changedFiles.filter(ignored);
    ...
    if (changedFiles.length) {
      import_npmlog36.default.verbose("filtered diff", changedFiles);
    } else {
      import_npmlog36.default.verbose("", "no diff found in %s (after filtering)", node.name);
    }
    return changedFiles.length > 0;
  };
}
function diffSinceIn2(committish, location, opts) {
  ...
  import_npmlog36.default.silly("checking diff", formattedLocation);
  return childProcess10.execSync("git", args, opts);
}
var import_minimatch3, import_npmlog36, import_path19, import_slash2, childProcess10;
...
function collectUpdates(filteredPackages, packageGraph, execOpts, commandOptions) {
  ...
  if (hasTags2(execOpts)) {
    const { sha, refCount, lastTagName } = describeRefSync(execOpts, commandOptions.includeMergedTags);
    if (refCount === "0" && forced.size === 0 && !committish) {
      import_npmlog37.default.notice("", "Current HEAD is already released, skipping change detection.");
      return [];
    }
    if (commandOptions.canary) {
      committish = `${sha}^..${sha}`;
  ...
  if (useConventionalGraduate) {
    if (forced.has("*")) {
      import_npmlog37.default.info("", "Graduating all prereleased packages");
    } else {
      import_npmlog37.default.info("", "Graduating prereleased packages");
    }
  } else if (!committish || forced.has("*")) {
    import_npmlog37.default.info("", "Assuming all packages changed");
    return collectPackages(packages, {
      onInclude: (name) => import_npmlog37.default.verbose("updated", name),
      excludeDependents
    });
  }
  import_npmlog37.default.info("", `Looking for changed packages since ${committish}`);
...
function reportCycles2(paths, rejectCycles) {
  ...
  import_npmlog38.default.warn("ECYCLE", cycleMessage);
}
var import_npmlog38;
...
function writeLogFile2(cwd) {
  let logOutput = "";
  import_npmlog39.default.record.forEach((m) => {
    let pref = [m.id, m.level];
    if (m.prefix) {
      pref.push(m.prefix);
    }
  ...
  import_npmlog39.default.record.length = 0;
}
var import_npmlog39, import_os4, import_path20, import_write_file_atomic2;
...
function logPackageError2(err, stream = false) {
  import_npmlog40.default.error(err.command, `exited ${err.exitCode} in '${err.pkg.name}'`);
  if (stream) {
    return;
  }
  if (err.stdout) {
    import_npmlog40.default.error(err.command, "stdout:");
    directLog2(err.stdout);
  }
  if (err.stderr) {
    import_npmlog40.default.error(err.command, "stderr:");
    directLog2(err.stderr);
  }
  import_npmlog40.default.error(err.command, `exited ${err.exitCode} in '${err.pkg.name}'`);
}
function directLog2(message) {
  import_npmlog40.default.pause();
  console.error(message);
  import_npmlog40.default.resume();
}
var import_npmlog40;
...
function warnIfHanging2() {
  const childProcessCount = childProcess11.getChildProcessCount();
  if (childProcessCount > 0) {
    import_npmlog41.default.warn(
      "complete",
      `Waiting for ${childProcessCount} child process${childProcessCount === 1 ? "" : "es"} to exit. CTRL-C to exit immediately.`
    );
  }
}
var import_npmlog41, childProcess11;
...
var import_clone_deep2, import_dedent5, import_execa2, import_npmlog42, import_os5, DEFAULT_CONCURRENCY2, Command2;
  ...
  "libs/legacy-core/src/lib/command/index.ts"() {
    ...
    Command2 = class {
      ...
      constructor(_argv, { skipValidations } = { skipValidations: false }) {
        ...
        import_npmlog42.default.heading = "lerna";
        const argv = (0, import_clone_deep2.default)(_argv);
        import_npmlog42.default.silly("argv", argv);
        this.name = this.constructor.name.replace(/Command$/, "").toLowerCase();
        this.composed = typeof argv.composed === "string" && argv.composed !== this.name;
        if (!this.composed) {
          import_npmlog42.default.notice("cli", `v${argv.lernaVersion}`);
        }
        let runner = new Promise((resolve3, reject) => {
          let chain = Promise.resolve();
          chain = chain.then(() => {
          ...
          chain.then(
            ...
            (err) => {
              if (err.pkg) {
                ...
                import_npmlog42.default.error("", cleanStack2(err, this.constructor.name));
              }
              if (err.name !== "ValidationError" && !err.pkg) {
      ...
      configureEnvironment() {
        ...
        let progress;
        if (ci || !process.stderr.isTTY) {
          import_npmlog42.default.disableColor();
          progress = false;
        } else if (!process.stdout.isTTY) {
          progress = false;
          loglevel = "error";
        } else if (process.stderr.isTTY) {
          import_npmlog42.default.enableColor();
          import_npmlog42.default.enableUnicode();
        }
        Object.defineProperty(this, "envDefaults", {
          value: {
            ci,
      ...
      configureLogging() {
        ...
        if (loglevel) {
          import_npmlog42.default.level = loglevel;
        }
        import_npmlog42.default.addLevel("success", 3001, { fg: "green", bold: true });
        Object.defineProperty(this, "logger", {
          value: import_npmlog42.default["newGroup"](this.name)
        });
        import_npmlog42.default.resume();
      }
      enableProgressBar() {
        if (this.options.progress !== false) {
          import_npmlog42.default.enableProgress();
        }
      }
      gitInitialized() {
        const opts = {
      ...
      runPreparations() {
        if (!this.composed && this.project.isIndependent()) {
          import_npmlog42.default.info("versioning", "independent");
        }
        if (!this.composed && this.options.ci) {
          import_npmlog42.default.info("ci", "enabled");
        }
        let chain = Promise.resolve();
...
var import_cmd_shim, import_fs_extra8, import_npmlog43;
...
function filterPackages(packagesToFilter, include = [], exclude = [], showPrivate, continueIfNoMatch) {
  ...
  if (patterns.length) {
    import_npmlog44.default.info("filter", patterns);
    if (!include.length) {
      patterns.unshift("**");
    }
...
var import_multimatch2, import_npmlog44, import_util3;
...
function getFilteredPackages(packageGraph, execOpts, opts) {
  const options = { log: import_npmlog45.default, ...opts };
  if (options.scope) {
    options.log.notice("filter", "including %j", options.scope);
  }
  if (options.ignore) {
...
var import_fs_extra10, import_npmlog46, readCmdShim;
  ...
  "libs/commands/diff/src/lib/get-last-commit.ts"(exports2, module2) {
    ...
    function getLastCommit(execOpts) {
      if (hasTags3(execOpts)) {
        import_npmlog63.default.silly("getLastTagInBranch");
        return childProcess24.execSync("git", ["describe", "--tags", "--abbrev=0"], execOpts);
      }
      import_npmlog63.default.silly("getFirstCommit");
    ...
    function hasTags3(opts) {
      ...
      try {
        ...
        import_npmlog63.default.warn("ENOTAGS", "No git tags were reachable from this branch!");
        import_npmlog63.default.verbose("hasTags error", err);
      }
      import_npmlog63.default.verbose("hasTags", result);
      return result;
    }
  }
});
...
var require_has_commit = __commonJS({
  "libs/commands/diff/src/lib/has-commit.ts"(exports2, module2) {
    ...
    function hasCommit(opts) {
      import_npmlog63.default.silly("hasCommit");
      let retVal;
      try {
      ...
      import_npmlog63.default.verbose("hasCommit", retVal);
      return retVal;
    }
  }
});
  ...
  "libs/commands/import/src/index.ts"(exports2, module2) {
    ...
    var ImportCommand = class extends Command {
      ...
      initialize() {
        ...
        const externalRepoPath = import_path26.default.resolve(inputPath);
        const externalRepoBase = import_path26.default.basename(externalRepoPath);
        ...
        const packageJson = import_path26.default.join(externalRepoPath, "package.json");
        ...
        const targetDir = import_path26.default.join(targetBase, externalRepoBase);
        const gitRepoRoot = this.getWorkspaceRoot();
        const lernaRootRelativeToGitRoot = import_path26.default.relative(gitRepoRoot, this.project.rootPath);
        this.targetDirRelativeToGitRoot = import_path26.default.join(lernaRootRelativeToGitRoot, targetDir);
        ...
        if (import_fs_extra14.default.existsSync(import_path26.default.resolve(this.project.rootPath, targetDir))) {
      ...
      getPackageDirectories() {
        return this.project.packageConfigs.filter((p) => p.endsWith("*")).map((p) => import_path26.default.dirname(p));
      }
      getTargetBase() {
...
var require_src7 = __commonJS({
  "libs/commands/init/src/index.ts"(exports2, module2) {
    ...
    var InitCommand = class {
      constructor(args) {
        this.args = args;
        import_npmlog63.default.heading = "lerna";
...
function getCurrentBranch(opts) {
  import_npmlog47.default.silly("getCurrentBranch");
  const branch = childProcess12.execSync("git", ["rev-parse", "--abbrev-ref", "HEAD"], opts);
  import_npmlog47.default.verbose("currentBranch", branch);
  return branch;
}
var import_npmlog47, childProcess12;
...
function maybeFormatFile(filePath) {
  ...
  if (resolvedPrettier.getFileInfo.sync(fullFilePath, { ignorePath }).ignored) {
    import_npmlog48.default.silly("version", `Skipped applying prettier to ignored file: ${filePath}`);
    return;
  }
  try {
    ...
    import_npmlog48.default.silly("version", `Successfully applied prettier to updated file: ${filePath}`);
  } catch {
    import_npmlog48.default.silly("version", `Failed to apply prettier to updated file: ${filePath}`);
  }
}
function gitAdd(changedFiles, gitOpts, execOpts) {
  ...
  import_npmlog48.default.silly("gitAdd", files);
  return childProcess13.exec("git", ["add", "--", ...files], execOpts);
}
var import_devkit5, import_fs5, import_npmlog48, import_path21, import_slash3, childProcess13, resolvedPrettier;
...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit }, opts) {
  import_npmlog49.default.silly("gitCommit", message);
  const args = ["commit"];
  ...
  import_npmlog49.default.verbose("git", args);
  return childProcess14.exec("git", args, opts);
}
var import_npmlog49, import_os6, childProcess14;
...
function gitPush(remote, branch, opts) {
  import_npmlog50.default.silly("gitPush", remote, branch);
  return childProcess15.exec("git", ["push", "--follow-tags", "--no-verify", "--atomic", remote, branch], opts).catch((error) => {
    if (/atomic/.test(error.stderr) || process.env.GIT_REDIRECT_STDERR === "2>&1" && /atomic/.test(error.stdout)) {
      import_npmlog50.default.warn("gitPush", error.stderr);
      import_npmlog50.default.info("gitPush", "--atomic failed, attempting non-atomic push");
      return childProcess15.exec("git", ["push", "--follow-tags", "--no-verify", remote, branch], opts);
    }
    throw error;
  });
}
...
function gitTag(tag, { forceGitTag, signGitTag }, opts, command = "git tag %s -m %s") {
  import_npmlog51.default.silly("gitTag", tag, command);
  ...
  import_npmlog51.default.verbose(cmd, interpolatedArgs);
  return childProcess16.exec(cmd, interpolatedArgs, opts);
}
var import_npmlog51, childProcess16;
...
function isAnythingCommitted(opts) {
  import_npmlog52.default.silly("isAnythingCommitted", "");
  const anyCommits = childProcess17.execSync("git", ["rev-list", "--count", "--all", "--max-count=1"], opts);
  import_npmlog52.default.verbose("isAnythingCommitted", anyCommits);
  return Boolean(parseInt(anyCommits, 10));
}
var import_npmlog52, childProcess17;
...
function updateRemote(opts) {
  childProcess18.execSync("git", ["remote", "update"], opts);
}
function countLeftRight(symmetricDifference, opts) {
  const stdout = childProcess18.execSync(
    "git",
...
function remoteBranchExists(gitRemote, branch, opts) {
  import_npmlog54.default.silly("remoteBranchExists", "");
  const remoteBranch = `${gitRemote}/${branch}`;
  try {
    childProcess19.execSync("git", ["show-ref", "--verify", `refs/remotes/${remoteBranch}`], opts);
    return true;
  } catch (e) {
    return false;
  }
...
async function updateLockfileVersion(pkg2) {
  ...
  const obj = await (0, import_load_json_file3.default)(lockfilePath).catch(() => {
    import_npmlog55.default.verbose("version", `${pkg2.name} has no lockfile. Skipping lockfile update.`);
  });
  if (!obj) {
    return;
  }
...
var import_devkit6, import_load_json_file3, import_npmlog55, import_path22;
      ...
      getVersionsForUpdates() {
        ...
        if (repoVersion) {
          ...
          const nextVersion = applyBuildMetadata(
            import_semver9.default.inc(this.project.version, increment, resolvePrereleaseId(prereleaseId)),
            this.options.buildMetadata
          );
    ...
    var command = {
      ...
      builder(yargs2, composed) {
        ...
        return yargs2.option("ignore", {
          ...
          if (argv["--"]) {
            import_npmlog63.default.warn("EDOUBLEDASH", "Arguments after -- are no longer passed to subprocess executions.");
            import_npmlog63.default.warn("EDOUBLEDASH", "This will cause an error in a future major version.");
          }
          return argv;
        });
      },
...
function getCurrentSHA(opts) {
  import_npmlog56.default.silly("getCurrentSHA", "");
  const sha = childProcess20.execSync("git", ["rev-parse", "HEAD"], opts);
  import_npmlog56.default.verbose("getCurrentSHA", sha);
  return sha;
}
...
async function getCurrentTags(execOpts, matchingPattern) {
  import_npmlog57.default.silly("getCurrentTags", "matching %j", matchingPattern);
...
var import_npm_package_arg8, import_npmlog57, childProcess21;
...
async function getProjectsWithTaggedPackages(projectNodes, rootPath, execOpts) {
  import_npmlog59.default.silly("getTaggedPackages", "");
  ...
  const manifests = stdout.split("\n").filter((fp) => import_path25.default.basename(fp) === "package.json");
  const locations = new Set(manifests.map((fp) => import_path25.default.join(rootPath, import_path25.default.dirname(fp))));
  return projectNodes.filter((node) => locations.has(getPackage(node).location));
}
var import_npmlog59, import_path25, childProcess22;
...
async function getProjectsWithUnpublishedPackages(projectNodes, opts) {
  import_npmlog60.default.silly("getProjectsWithUnpublishedPackages", "");
  const mapper = (node) => {
    const pkg2 = getPackage(node);
    return import_pacote.default.packument(pkg2.name, opts).then(
      ...
      () => {
        import_npmlog60.default.warn("", "Unable to determine published version, assuming %j unpublished.", pkg2.name);
        return node;
      }
    );
  };
...
var import_npmlog60, import_p_map6, import_pacote;
...
function gitCheckout(stagedFiles, gitOpts, execOpts) {
  ...
  import_npmlog61.default.silly("gitCheckout", files);
  return childProcess23.exec("git", ["checkout", "--"].concat(files), execOpts);
}
  ...
  "libs/commands/publish/src/index.ts"(exports2, module2) {
    ...
    var PublishCommand = class extends Command {
      ...
      async detectFromGit() {
        ...
        if (!taggedPackageNames.length) {
          ...
          updates = taggedPackageNames.map(
            (name) => this.projectsWithPackage.find((node) => getPackage(node).name === name)
      ...
      async detectCanaryVersions() {
        ...
        const updates = await this.filterPrivatePkgUpdates(
      ...
      async resetChanges() {
        ...
        const dirtyManifests = [this.project.manifest].concat(this.packagesToPublish).map((pkg2) => import_path26.default.relative(_workspaceRoot, pkg2.manifestLocation));
      ...
      execScript(pkg2, script) {
        const scriptLocation = import_path26.default.join(pkg2.location, "scripts", script);
        try {
        ...
        const mapper = (0, import_p_pipe.default)(
          ...[
            ...
            (pkg2) => pulseTillDone(packDirectory(pkg2, pkg2.location, opts)).then((packed) => {
              tracker.verbose("packed", import_path26.default.relative(this.project.rootPath, pkg2.contents));
              tracker.completeWork(1);
              pkg2.packed = packed;
              return pkg2.refresh();
            })
      ...
      async copyAssets(pkg2) {
        if ((0, import_path26.normalize)(pkg2.location) === (0, import_path26.normalize)(pkg2.contents)) {
          return;
        }
        const _workspaceRoot = process.env["NX_WORKSPACE_ROOT_PATH"] || import_devkit8.workspaceRoot;
        const assets = pkg2.lernaConfig?.command?.publish?.assets || ["package.json", "README.md"];
        const filesToCopy = [];
        ...
        for (const asset of assets) {
          if (typeof asset === "string") {
            ...
            for (const file of files) {
              filesToCopy.push({
                from: (0, import_path26.join)(pkg2.location, file),
                to: (0, import_path26.join)(pkg2.contents, file)
              });
            }
            ...
            for (const file of files) {
              filesToCopy.push({
                from: (0, import_path26.join)(pkg2.location, file),
                to: (0, import_path26.join)(pkg2.contents, asset.to, (0, import_path26.basename)(file))
              });
            }
          } else {
            throw new ValidationError(
        ...
        for (const file of filesToCopy) {
          if ((0, import_path26.normalize)(file.from) === (0, import_path26.normalize)(file.to)) {
            this.logger.warn(
              "EPUBLISHASSET",
      ...
      builder(yargs2) {
        ...
        return yargs2.option("npm-tag", {
          ...
          if (argv["npmTag"]) {
            ...
            delete argv["npmTag"];
            delete argv["npm-tag"];
            import_npmlog63.default.warn("deprecated", "--npm-tag has been renamed --dist-tag");
          }
          return argv;
        }).middleware((args) => {
...
var require_src11 = __commonJS({
  "libs/commands/run/src/index.ts"(exports2, module2) {
    ...
    var RunCommand = class extends Command {
      ...
      async prepNxOptions() {
        const nxJsonExists = (0, import_fs_extra14.existsSync)(import_path26.default.join(this.project.rootPath, "nx.json"));
...
`
        ...
        import_npmlog63.default.resume();
        process.stdout.write("\n");
...
var require_repair = __commonJS({
  "packages/lerna/src/commands/repair/index.ts"(exports2, module2) {
    ...
    var RepairCommand = class extends Command {
      ...
      async execute() {
        this.configureNxOutput();
        const verbose = this.options?.verbose ? true : import_npmlog63.default.level === "verbose";
...
var import_npmlog62 = __toESM(require("npmlog"));
init_src();

...
var require_src = __commonJS({
  "libs/commands/import/src/index.ts"(exports2, module2) {
    ...
    var ImportCommand = class extends Command {
      ...
      execSync(cmd, args) {
        return childProcess9.execSync(cmd, args, this.execOpts);
      }
      externalExecSync(cmd, args) {
        return childProcess9.execSync(cmd, args, this.externalExecOpts);
      }
...
${version}`;
      ...
      execute() {
        ...
        const mapper = (sha) => {
          ...
          const proc = childProcess9.exec("git", procArgs, this.execOpts);
          ...
          return pulseTillDone(proc).then(() => {
            ...
            if (diff === "") {
              tracker.completeWork(1);
              return childProcess9.exec("git", ["am", "--skip"], this.execOpts);
            }
            err.sha = sha;
            throw err;
          });

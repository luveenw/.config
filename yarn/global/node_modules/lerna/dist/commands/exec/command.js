  ...
  "libs/commands/exec/src/index.ts"(exports2, module2) {
    ...
    var ExecCommand = class extends Command {
      ...
      runCommandInPackageStreaming(pkg) {
        return childProcess9.spawnStreaming(this.command, this.args, this.getOpts(pkg), this.prefix && pkg.name);
      }
      runCommandInPackageCapturing(pkg) {
        return childProcess9.spawn(this.command, this.args, this.getOpts(pkg));
      }
    };

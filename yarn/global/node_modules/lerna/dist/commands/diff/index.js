  ...
  "libs/commands/diff/src/lib/get-last-commit.ts"(exports2, module2) {
    ...
    function getLastCommit(execOpts) {
      if (hasTags2(execOpts)) {
        import_npmlog35.default.silly("getLastTagInBranch");
        return childProcess9.execSync("git", ["describe", "--tags", "--abbrev=0"], execOpts);
      }
      import_npmlog35.default.silly("getFirstCommit");
      return childProcess9.execSync("git", ["rev-list", "--max-parents=0", "HEAD"], execOpts);
    }
...
var require_has_commit = __commonJS({
  "libs/commands/diff/src/lib/has-commit.ts"(exports2, module2) {
    ...
    function hasCommit(opts) {
      import_npmlog35.default.silly("hasCommit");
      let retVal;
      try {
        childProcess9.execSync("git", ["log"], opts);
        retVal = true;
      } catch (e) {
        retVal = false;
      }
      import_npmlog35.default.verbose("hasCommit", retVal);
      return retVal;
    }
  }
});
...
var require_src = __commonJS({
  "libs/commands/diff/src/index.ts"(exports2, module2) {
    ...
    var DiffCommand = class extends Command {
      ...
      execute() {
        return childProcess9.spawn("git", this.args, this.execOpts).catch((err) => {
          if (err.exitCode) {
            throw err;
          }
        });

...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit }, opts) {
  import_npmlog35.default.silly("gitCommit", message);
  const args = ["commit"];
  ...
  import_npmlog35.default.verbose("git", args);
  return childProcess9.exec("git", args, opts);
}
var import_npmlog35, import_os2, childProcess9;

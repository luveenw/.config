...
function collectUncommitted({ cwd, log: log42 = import_npmlog.default }) {
  log42.silly("collect-uncommitted", "git status --porcelain (async)");
...
var import_fs_extra5, import_libnpmpublish, import_npm_package_arg5, import_npmlog24, import_pify2, readJSON, readJSONAsync;
...
var import_npm_packlist, import_npmlog27, import_tar2;
...
var import_node_fetch, import_npmlog32, import_path14, GitLabClient;
...
var import_devkit5, import_fs4, import_npmlog36, import_path15, import_slash2, childProcess10, resolvedPrettier;
...
var import_devkit6, import_load_json_file3, import_npmlog43, import_path16;
...
var require_src = __commonJS({
  "libs/commands/version/src/index.ts"(exports2, module2) {
    ...
    var childProcess17 = require("@lerna/child-process");
    ...
    var VersionCommand = class extends Command {
      ...
      async updatePackageVersions() {
        ...
        if (this.options.npmClient === "yarn") {
          const yarnVersion = await childProcess17.execSync("yarn", ["--version"], this.execOpts);
          ...
          if (import_semver8.default.gte(yarnVersion, "2.0.0")) {
            ...
            await childProcess17.exec("yarn", ["install", "--mode", "update-lockfile", ...npmClientArgs], {
              ...this.execOpts,
              env: {
                ...process.env,
...
var require_command = __commonJS({
  "libs/commands/version/src/command.ts"(exports2, module2) {
    "use strict";
    var import_npmlog44 = __toESM(require("npmlog"));
    var import_semver8 = __toESM(require("semver"));
    ...
    var command = {
      ...
      builder(yargs2, composed) {
        ...
        return yargs2.option("ignore", {
          ...
          if (argv["--"]) {
            import_npmlog44.default.warn("EDOUBLEDASH", "Arguments after -- are no longer passed to subprocess executions.");
            import_npmlog44.default.warn("EDOUBLEDASH", "This will cause an error in a future major version.");
          }
          return argv;
        });
      },
